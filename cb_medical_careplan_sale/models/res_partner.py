...
class ResPartner(models.Model):
    ...
    is_sub_payor = fields.Boolean(
        default=False,
    )
    edit_sub_payor = fields.Boolean(
        default=_default_edit_sub_payor,
        compute='_compute_edit_sub_payor',
    )
    sub_payor_identifier = fields.Char(
        readonly=True,
