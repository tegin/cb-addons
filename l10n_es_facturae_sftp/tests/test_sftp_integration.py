    ...
    def test_process(self):
        ...
        class SftpConnection:
            ...
            def remove(self, filename):
                return
        patch_class = 'odoo.addons.l10n_es_facturae_sftp.models.' \
        ...
        self.assertEqual(integration.method_id.code, "SFTP")
